      ...
      <Wrap>
        <Layout>
              <ImageCardMobile>
                ...
                <ContentBox>
                $BAMBOO smart contract address: <br/><LineBreak>0x42AD6b92CeD60bb8C39411f1BE97e5884BF8D515</LineBreak>
                </ContentBox>
            </ImageCardMobile>
            <DataLayout>
               ...
               <b> 1 $BAMBOO = 1 $BAMBOO </b>
                ...
                <InnerBox>
                    ...
                    <InnerWrap>
                        ...
                        <Header>Mint</Header>
                        <InnerBody>
                            Looking for a companion for your PPPanda? All you
                            need is 500 $BAMBOO + 1 PPPanda and you will be
                            able to mint 1 PPPal** in the upcoming drop (launching
                            mid-December).
                        </InnerBody>
                    </InnerWrap>
                </InnerBox>
                ...
                <InnerBox>
                    <InnerWrap>
                        {/*  Purple Panda Image */}
                        <PurplePanda alt="Purple Panda Image" src={PurplePandaImg5} />
                    </InnerWrap>
                    <InnerWrap>
                        {/* Text + Minting Wrap */}
                        <Header>Breed</Header>
                        <InnerBody>
                          Will be available after launch of PPPals. Hold two
                          PPPals in your wallet and burn 1000 $BAMBOO to
                          receive an incubator for baby PPPals.
                        </InnerBody>
                    </InnerWrap>
                </InnerBox>
                <InnerBox>
            ...
            <ImageCard>
                ...
                <LineBreak>0x42AD6b92CeD60bb8C39411f1BE97e5884BF8D515</LineBreak>
                </ContentBoxDesktop>
                <ShopBox>

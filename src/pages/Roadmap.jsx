        ...
        <Stage flip>
          <TextWithIcon left>
            ...
            <Card left>
              ...
              <div style={{display:"flex",alignItems: "baseline"}}>
              <CardHeading>Sept 2021</CardHeading>
              <Checkmark src={checkmark} />
              </div>
              <CardBody>
                <ul>
                  <RoadmapLi>Official Website Published</RoadmapLi>
                  <RoadmapLi>Artwork & roadmap revealed</RoadmapLi>
                  <RoadmapLi>Pre-sale for whitelisted members</RoadmapLi>
                  <RoadmapLi>PPPandas Public Sale</RoadmapLi>
                  <RoadmapLi>10 PPPandas Airdropped to PPPandas holders at 10% sales</RoadmapLi>
                </ul>
              </CardBody>
            </Card>
          </TextWithIcon>
        ...
        <Stage flip>
          <TextWithIcon left>
            ...
            <Card left>
              ...
              <CardBody>
                <ul>
                  <RoadmapLi>Listing On Rarity Tools & Rarity Sniper</RoadmapLi>
                  <RoadmapLi>Diamond Hands Bamboo Club daily raffle for PPPanda holders</RoadmapLi>
                  <RoadmapLi>PPPandas meme contest & other giveaways</RoadmapLi>
                  <RoadmapLi>Pandamic #4000 Charity Auction - donation made to Mona</RoadmapLi>
                  <RoadmapLi>Planning & development of PPPal NFT, playmate for PPPandas NFT</RoadmapLi>
                </ul>
              </CardBody>
            </Card>
        ...
        <Stage flip>
          <TextWithIcon left>
            ...
            <Card left>
              ...
              <CardBody>
                <ul>
                  <RoadmapLi>Community wallet creation - 5 ETH from sales will be added</RoadmapLi>
                  <RoadmapLi>3% of sales will be donated to charity</RoadmapLi>
                  <RoadmapLi>Top holders eligible for 1/1 art from our artist, Peep</RoadmapLi>
                  <RoadmapLi>Art competition</RoadmapLi>
                  <RoadmapLi>Exclusive giveaways & events for PPPanda Fam</RoadmapLi>
                </ul>
              </CardBody>
            </Card>
          </TextWithIcon>
